# from flask import Flask, render_template, url_for, jsonify, json, request, redirect, flash, session
...
#         # Creates new user
#         new_user = User(name=name, email=email, phone_number=phone_number, password_hash=hashed_password)
